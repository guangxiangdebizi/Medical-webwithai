...
class ShareModule {
    ...
    shareChat() {
        if (!this.chatApp.sessionId) {
            this.chatApp.showError('Cannot share: no active conversation session');
            return;
        }
        ...
        modal.innerHTML = `
            <div class="share-modal-content">
                ...
                <div class="share-modal-body">
                    <p>Share current conversation via the following link:</p>
                    ...
                    <div class="share-notice">
                        ...
                        <ul>
                            <li>Shared conversations are read-only, others cannot continue the conversation</li>
                            <li>Please ensure conversation content does not contain sensitive information</li>
                            <li>Share link contains complete conversation history</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    bindShareModalEvents(modal, shareUrl) {
        ...
        copyBtn.addEventListener('click', async () => {
            try {
                ...
                this.chatApp.showError('Copy failed', 'Please manually select and copy the link');
            }
        });
